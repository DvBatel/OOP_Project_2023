...
public class CountdownAnimation implements Animation {
    ...
    public void doOneFrame(DrawSurface d) {
        ...
        if (counter != Const.ZERO) {
            d.drawText(Const.FOUR_HUNDRED, d.getHeight() / Const.TWO,
                    String.valueOf(counter), Const.FONT_SIZE);
            d.drawText(Const.THREE_HUNDRED, d.getHeight() / Const.TWO
                            + Const.FIFTY, "Press 'p' if you wish to pause",
                            Const.FONT_SIZE / Const.TWO);
        }
